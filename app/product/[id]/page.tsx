      ...
      <main className="bg-[#EAEDED] min-h-screen">
        <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-4">
            <Link
              href="/"
              className="w-fit text-sm text-[#007185] hover:text-[#C7511F] hover:underline"
            >
              ← Back to products
            </Link>
          </div>
          <div className="grid gap-8 bg-white border border-gray-200 rounded-sm p-6 md:grid-cols-2">
